		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktlayoutlayoutexamp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktlayoutlayoutexamp-display": {
								"semanticObject": "comsapktlayoutlayoutexamp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.layout.layoutexamp",
									"url": sap.ui.require.toUrl("com/sap/kt/layout/layoutexamp")
								}
							}
						}
					}
